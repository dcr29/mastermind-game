...
class DoneLine:
    ...
    def move(self, y):  # positionne les billes à partir d'un point donné
    ...
    def draw(self, screen): # affiche la ligne de bille et le nombre de billes bien/mal placées
        ...
        text_y = self.y + self.ball_radius // 2
        ...
        font_nb_try = pygame.font.Font(None, self.ball_radius)
        text_nb_Try = font_nb_try.render(str(self.try_number), True, (0,0, 0))
        screen.blit(text_nb_Try, (self.x - spacing, text_y + self.ball_radius//3))